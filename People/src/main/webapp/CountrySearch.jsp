...
<nav class="navbar navbar-dark bg-primary">
    ...
    <!-- Add your logo here -->
        ...
        <a class="navbar-brand  text-dark" href="Country.jsp"><b>Country</b></a>
...
<div class="card">
  <div class="card-body">
    <strong style="color:green;">Search result for , ${state}</strong>
<table class="table">
  <thead>
    <tr>
      <th scope="col">ID</th>
  ...
  <tbody>
       <c:forEach items="${listOfCountry}" var="country">
               <tr>
                            <td>${country.id}</td>
                            <td>${country.name}</td>
