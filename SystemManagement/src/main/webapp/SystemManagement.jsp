...

{
    ...
    if(element.value.length >1 && element.value.length <10 && lastNameRegex.test(element.value))
    {
        error.innerHTML = "";
    ...
    {
        error.innerHTML = "Invalid lastName. Characters should be greaterthan 1 and lessthan 20 ";
        error.style.color="red"
